%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{LIMITIERENDE REAKTANTEN - ST"OCHIOMETRIE}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{karte}{
		Stellen Sie sich vor, Sie wollen einen Prozess verbessern, in dem aus Eisenerz, das \ce{Fe_{2}O_{3}} enthält, Eisen gewonnen wird. Als Testexperiment führen sie folgende Reaktion durch: \ce{Fe_{2}O_{3} +3CO -> 2Fe +3CO_{2}}\\
		Schreiben Sie für alle Atome die Oxidationszahlen an. \\
		Wenn Sie mit 150 g \ce{Fe_{2}O_{3}} limitierendem Reaktanten beginnen, wie groß ist die theoretische Ausbeute an \ce{Fe}? \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{karte}{
		Fluorwasserstoffsäure kann nicht in Glasbehältern aufbewahrt werden, weil Silikate von \ce{HF} angegriffen werden. Natriumsilikat reagiert z.B. wie folgt: \\
		\ce{Na_{2}SiO_{3} +8HF -> H_{2}SiF_{6} +2NaF +3H_{2}O} \\
		Wie viel Mol \ce{HF} werden benötigt, um mit 0.300 Mol \ce{Na_{2}SiO_{3}} zu reagieren? \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{karte}{
		Wenn ein Gemisch aus 10.0 g Acetylen $(H-C\text{\ensuremath{\equiv}}C-H)$ und 10 g Sauerstoff entzündet wird, entsteht bei der Verbrennungsreaktion \ce{CO_{2}} und \ce{H_{2}O}. \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{karte}{
		Eine Probe von 70.5 mg \ce{K3PO4} wird zu 15.0 mL 0.4 molarer \ce{AgNO3} -Lösung gegeben. Es fällt ein Niederschlag aus. \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\begin{karte}{
		Eine Probe aus festem \ce{Ca(OH)_{2}} wird bei 30°C in Wasser gerührt, bis die Lösung mit \ce{Ca(OH)_{2}} gesättigt ist. 100 mL dieser Probe werden entnommen und mit $5,00\cdot10^{-2}$ Mol/L \ce{HBr}-Lösung titriert. Zur Neutralisation der Probe werden 48.8 mL der Säurelösung benötigt. \\
		Welche Konzentration hat die \ce{Ca(OH)_{2}}-Lösung? \\
		Wie groß ist bei 30°C die Löslichkeit von \ce{Ca(OH)_{2}} in Wasser (Angabe in g \ce{Ca(OH)_{2}} pro Liter).
		}
		\begin{enumerate}
			\item
